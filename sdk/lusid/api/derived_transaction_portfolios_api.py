...
class DerivedTransactionPortfoliosApi(object):
    ...
    def create_derived_portfolio(self, scope, **kwargs):  # noqa: E501
        ...
        :param CreateDerivedTransactionPortfolioRequest portfolio: The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope
    ...
    def create_derived_portfolio_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'portfolio']  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `scope` when calling `create_derived_portfolio`")  # noqa: E501
    ...
    def delete_derived_portfolio_details_with_http_info(self, scope, code, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('scope' not in local_var_params or  # noqa: E501
                                                        local_var_params['scope'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `scope` when calling `delete_derived_portfolio_details`")  # noqa: E501
        # verify the required parameter 'code' is set
        if self.api_client.client_side_validation and ('code' not in local_var_params or  # noqa: E501
                                                        local_var_params['code'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `code` when calling `delete_derived_portfolio_details`")  # noqa: E501
