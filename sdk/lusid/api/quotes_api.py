...
class QuotesApi(object):
    ...
    def delete_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param dict(str, QuoteId) quotes: The quotes to delete keyed by a unique correlation id.
    ...
    def get_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param dict(str, QuoteSeriesId) quote_ids: The time invariant quote series ids of the quotes to retrieve. These need to be               keyed by a unique correlation id allowing the retrieved quote to be identified in the response.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_quotes_with_http_info(self, scope, **kwargs):  # noqa: E501
        ...
        all_params = ['scope', 'effective_at', 'as_at', 'max_age', 'quote_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def upsert_quotes(self, scope, **kwargs):  # noqa: E501
        ...
        :param dict(str, UpsertQuoteRequest) quotes: The quotes to update or insert keyed by a unique correlation id.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
