...
class PropertyDefinitionsApi(object):
    ...
    def create_property_definition(self, definition, **kwargs):  # noqa: E501
        """Create property definition  # noqa: E501

        Define a new property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_property_definition(definition, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param CreatePropertyDefinitionRequest definition: The definition of the new property. (required)
        ...
        return self.create_property_definition_with_http_info(definition, **kwargs)  # noqa: E501

    def create_property_definition_with_http_info(self, definition, **kwargs):  # noqa: E501
        """Create property definition  # noqa: E501

        Define a new property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_property_definition_with_http_info(definition, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['definition']  # noqa: E501
        ...
        body_params = None
        if 'definition' in local_var_params:
            body_params = local_var_params['definition']
        # HTTP header `Accept`
    ...
    def update_property_definition(self, domain, scope, code, definition, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_property_definition(domain, scope, code, definition, async_req=True)
        >>> result = thread.get()
        ...
        :param UpdatePropertyDefinitionRequest definition: The updated definition of the property. (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_property_definition_with_http_info(domain, scope, code, definition, **kwargs)  # noqa: E501

    def update_property_definition_with_http_info(self, domain, scope, code, definition, **kwargs):  # noqa: E501
        """Update property definition  # noqa: E501

        Update the definition of a specified existing property. Not all elements within a property definition  are modifiable due to the potential implications for values already stored against the property.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_property_definition_with_http_info(domain, scope, code, definition, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['domain', 'scope', 'code', 'definition']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
