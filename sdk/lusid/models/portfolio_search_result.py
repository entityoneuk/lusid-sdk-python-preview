...
class PortfolioSearchResult(object):
    ...
    def __init__(self, id=None, type=None, href=None, description=None, display_name=None, is_derived=None, created=None, parent_portfolio_id=None, properties=None, links=None, local_vars_configuration=None):  # noqa: E501
