...
class UpsertRecipeRequest(object):
    ...
    def __init__(self, code=None, configuration_recipe=None, configuration_recipe_snippet=None, local_vars_configuration=None):  # noqa: E501
        """UpsertRecipeRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def configuration_recipe(self, configuration_recipe):
        ...
        """
        if self.local_vars_configuration.client_side_validation and configuration_recipe is None:  # noqa: E501
            raise ValueError("Invalid value for `configuration_recipe`, must not be `None`")  # noqa: E501
    ...
    def configuration_recipe_snippet(self, configuration_recipe_snippet):
        ...
        """
        if self.local_vars_configuration.client_side_validation and configuration_recipe_snippet is None:  # noqa: E501
            raise ValueError("Invalid value for `configuration_recipe_snippet`, must not be `None`")  # noqa: E501
