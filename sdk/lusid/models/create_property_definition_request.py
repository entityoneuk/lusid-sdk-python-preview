...
class CreatePropertyDefinitionRequest(object):
    ...
    def __init__(self, domain=None, scope=None, code=None, value_required=None, display_name=None, data_type_id=None, life_time=None, local_vars_configuration=None):  # noqa: E501
