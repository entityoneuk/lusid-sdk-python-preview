...
class FxForwardInstrument(object):
    ...
    def __init__(self, dom_amount=None, fgn_amount=None, is_ndf=None, fixing_date=None, fgn_ccy=None, ref_spot_rate=None, start_date=None, maturity_date=None, dom_ccy=None, instrument_type=None, local_vars_configuration=None):  # noqa: E501
